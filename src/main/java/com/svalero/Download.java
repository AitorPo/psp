...
public class Download extends Thread implements  Runnable{
    ...
    public void setResume(){ cancel = false; }
            ...
            try {
                ...
                while ((ridden = bis.read(buffer, 0, BUFFER_SIZE)) >= 0) {
                    ...
                    if (dataToFullDownload == 0) {
                        Platform.runLater(() ->{
                            AlertUtils.showAlert("Descarga completada");
                            lblStatus.setText("Descarga completada");
                        });
                    }
                    ...
                    if (cancel) {
                        Platform.runLater(() ->{
                                ...
                                AlertUtils.showAlert("Descarga cancelada");
                    ...
                    if(delete){
                        Platform.runLater(() -> AlertUtils.showAlert("Descarga eliminada"));
                        return;
                    }
